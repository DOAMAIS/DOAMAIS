    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="align-items-center" id="logo">
            <h1 class="text-gray-dark display-1">DOAMAIS</h1>
            <p class="lead text-grey">Uma iniciativa feita por alunos, para alunos.</p>
            <a href="quemsomos.php" class="btn  text-center" id="botao" data-toggle="">Conheça!</a> <b><br></b>
            <a class="btn m-1 text-center" id="botao" href="cadastro.php">Cadastre-se<i class="fa fa-check fa-fw"></i></a>
          </div>
        </div>
      </div>
    </div>
